    ...
    function pageRevealEffects() {
        ...
        gsap.registerEffect({
            ...
            effect: (target, config) => {
                ...
                if (!headerLogo && !headerMenu && !uiElements && !classicMenu)
                    return;
    ...
    const PageReveal = (function () {
        ...
        function mastheadType_3(tl) {
            ...
            if (masthead.querySelector('.js-subtitle')) {
                subtitle = masthead.querySelectorAll(
                    '.js-subtitle .split__line'
                );
            }
        ...
        function mastheadPortfolioWorkType_1(tl) {
            ...
            const subtitle = masthead.querySelectorAll(
                '.js-subtitle .split__line'
            );
            const title = masthead.querySelectorAll('.js-title .split__line');
            const infoItems = masthead.querySelectorAll(
...
---------------------------------------------------*/
    ...
    function masonryFilterInit() {
        ...
        for (let i = 0; i < filterGrids.length; i++) {
            ...
            const filterButtons = el.querySelectorAll(
    ...
    function masonryGridInit() {
        const grids = document.querySelectorAll(
            '.js-masonry.js-masonry-no-filter'
        );
